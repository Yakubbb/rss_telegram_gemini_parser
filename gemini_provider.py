...
class GeminiProvider:
    ...
    @staticmethod
    def create_system_prompt(avalible_events:list[str], avalible_categories:list[str]) ->str :
        return f"""Ты выступаешь в роли группировщика новостей в аггрегаторе по категориям и событиям. 
                ...
                {{title:заголовок новости который ты получил, new_title?:название если оригинальное название это ссылка event?:событие по этой новости, category:[массив категорий новости]}}.
